...
VISITED_RADIUS = 5           # rayon autour d'un pixel pour marquer visité
MAX_STEP = 50                # distance max pour chercher le prochain pixel
...
def main():
    ...
    # Liste de tous les pixels rouges pour KDTree ou recherche
    ...
    while pixels_visited_count < total_pixels:
        ...
        while True:
            # Pixels candidats : non visités dans MAX_STEP autour du current
