    ...
    try:
        ...
        while True:
            ...
            if msg_type == MESSAGE_POSITION:
                ...
                trace_itin.calcul_et_interpolation_itin(NODES_FILE, ARCS_FILE, pos,SPARSE_OUTPUT_FILE,DENSE_OUTPUT_FILE)
                print(f"[IHM] Calcul d'itinéraire effectué avec la position {pos}")
